...
export class TournamentComponent implements OnInit {
  ...
  async setImageTeamA() {
    for (
      ...
      if (this.match_list[index].match.teamA.imageTeamUrl) {
        (
          await this.nav.service.getImage(
            this.match_list[index].match.teamA.imageTeamUrl
          )
        ).subscribe(
          (res) => {},
          (result) => {
  ...
  async setImageTeamB() {
    for (
      ...
      if (this.match_list[index].match.teamB.imageTeamUrl) {
        (
          await this.nav.service.getImage(
            this.match_list[index].match.teamB.imageTeamUrl
          )
        ).subscribe(
          (res) => {},
          (result) => {
